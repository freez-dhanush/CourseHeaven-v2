...
function Courses() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gray-800 w-64 p-5 transform z-10 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <nav>
          <ul>
            ...
            <li className="mb-4">
              <a href="/purchases" className="flex items-center text-gray-300 hover:text-white">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex items-center">
              <input
                ...
                className="border border-gray-700 bg-gray-800 text-white rounded-l-full px-4 py-2 h-10 focus:outline-none placeholder-gray-400"
              />
              <button className="h-10 border border-gray-700 bg-gray-800 rounded-r-full px-4 flex items-center justify-center">
